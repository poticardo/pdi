...
Below we have the tilt-shift code, the algorithm simulates a change in the focus of the image, partially blurring it.

This technique is very used in cinema industy, a recent example is the 2018 movie, Hereditary, where using the tilt-shift we have the footage looking like miniatures.
